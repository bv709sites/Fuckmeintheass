...
LunarUI:CreateWindow("ByfronPlayer V3", "Byfron is gay")

LunarUI:CreateTab("LocalPlayer")

-- Function to change WalkSpeed
function setYourWalkSpeed()
    local walkspeed = tonumber(LunarUI:GetTextBoxValue("Walkspeed"))
    if walkspeed then
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = walkspeed
    else
        warn("Invalid walkspeed value entered")
    end
end

-- TextBox for WalkSpeed
LunarUI:TextBox("LocalPlayer", "Walkspeed")

-- Button to change WalkSpeed
LunarUI:CreateButton("LocalPlayer", "Change WalkSpeed", "Change walkspeed", setYourWalkSpeed)


-- Function to change JumpPower
function setYourJumpPower()
    local jumppower = tonumber(LunarUI:GetTextBoxValue("JumpPower"))
    if jumppower then
...
LunarUI:TextBox("LocalPlayer", "JumpPower")

-- Button to change JumpPower
LunarUI:CreateButton("LocalPlayer", "Change JumpPower", "Change JumpPower", setYourJumpPower)


-- Function to change Health
function setYourHealth()
    local health = tonumber(LunarUI:GetTextBoxValue("Health"))
    if health then
...
-- TextBox for Health
LunarUI:TextBox("LocalPlayer", "Health")

-- Button to change Health
LunarUI:CreateButton("LocalPlayer", "Change Health", "Change Health", setYourHealth)


-- Function to change MaxHealth
function setYourMaxHealth()
    local maxHealth = tonumber(LunarUI:GetTextBoxValue("MaxHealth"))
    if maxHealth then
        game.Players.LocalPlayer.Character.Humanoid.MaxHealth = maxHealth
    else
        warn("Invalid max health value entered")
    end
end

-- TextBox for MaxHealth
LunarUI:TextBox("LocalPlayer", "MaxHealth")

-- Button to change MaxHealth
LunarUI:CreateButton("LocalPlayer", "Change MaxHealth", "Change MaxHealth", setYourMaxHealth)


-- Function to change Gravity (if applicable in your game)
...
-- TextBox for Gravity
LunarUI:TextBox("LocalPlayer", "Gravity")

-- Button to change Gravity
LunarUI:CreateButton("LocalPlayer", "Change Gravity", "Change Gravity", setYourGravity)
...
-- Button to kill the player
LunarUI:CreateButton("LocalPlayer", "Kill", "Kill Yourself", killYourself)
